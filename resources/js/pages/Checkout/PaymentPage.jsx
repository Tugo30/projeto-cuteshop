                ...
                <div className="mt-10 flex flex-col items-center">
                    ...
                    {data.pix_payload && (
                        <section className="w-full mt-10">
                            ...
                            {qrSrc && (
                                <img src={qrSrc} alt="QR Code Pix" className="mx-auto w-56 h-56 bg-white border border-border p-3" />
                            )}
                            <textarea
                                readOnly
                            ...
                            <button
                                type="button"
                                onClick={() => copyText(data.pix_payload, "pix", "Codigo Pix copiado.")}
                    ...
                    <p className="mt-8 text-[13px] text-[#5C5A55] text-center leading-relaxed">
                        Cartao entra depois, com tokenizacao da Getnet. A zLuz nao recebe numero nem CVV.
                    </p>
                    <p className="mt-5 text-[12px] text-[#8A877F] text-center leading-relaxed">
                        Depois do pagamento, esta pagina confirma sozinha em alguns segundos.
                    </p>
                </div>
            )}
        </div>
